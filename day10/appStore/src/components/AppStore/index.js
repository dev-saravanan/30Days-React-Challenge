...
class AppStore extends Component {
  ...
  changeTab = id => this.setState({tabId: id})
  ...
  render() {
    ...
    const filteredAppList = appsList.filter(eachAppDetail => {
      const eachAppName = eachAppDetail.appName.toLowerCase()
      const appCategory = eachAppDetail.category
      return appCategory === tabId && eachAppName.includes(searchInput)
    })

    return (
      <div className="bg-container">
        <h1 className="heading-text">App Store</h1>
